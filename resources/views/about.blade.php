...
<section class="w-full flex justify-center px-4 py-20 ">
  <div class="w-full max-w-5xl bg-white shadow-xl rounded-2xl p-8 mb-16 text-center">
    <h2 class="text-4xl font-bold text-gray-800 mb-10 border-b-4 border-yellow-400 inline-block pb-2">
      Tentang Kami
    </h2>
    <div class="flex flex-wrap justify-center gap-12">
      @php
        $teams = [
          ['name' => 'Andhika Eka', 'img' => '/images/dika.jpg'],
          ['name' => 'Yusuf Rizqy Mubarok', 'img' => '/images/yusuf.jpg'],
          ['name' => 'Wisnu Ibrahima', 'img' => '/images/wisnu.jpg'],
        ];
      @endphp

      @foreach ($teams as $member)
      <div class="flex flex-col items-center transition-transform hover:scale-105">
        <div class="bg-yellow-400 p-2 rounded-full shadow-lg">
...
<section class="w-full flex justify-center px-4 pb-20">
  <div class="w-full max-w-5xl bg-white shadow-xl rounded-2xl p-8">
    <h2 class="text-3xl font-bold text-gray-800 mb-10 text-center border-b-4 border-[#FFF5CC] inline-block pb-2">
      Apa Kata Developer
    </h2>
    ...
    <div class="space-y-8">
      ...
      <div class="flex flex-col md:flex-row items-center md:items-start gap-6 p-6 rounded-lg hover:bg-gray-50 transition-all duration-300">
        <img src="{{ $dev['img'] }}" class="rounded-full w-20 h-20 object-cover shadow-md border-2 border-yellow-400" alt="{{ $dev['name'] }}">
        <div class="text-center md:text-left max-w-xl">
          <h3 class="text-sm text-yellow-400 font-bold uppercase tracking-wide">{{ $dev['role'] }}</h3>
