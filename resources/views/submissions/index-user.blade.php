...
@section('content')
    <div class="max-w-3xl mx-auto mt-8">
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-700 text-white rounded-2xl shadow-lg p-6 mb-6">
        ...
        <div class="bg-white rounded-xl shadow p-6 mb-6">
            <h2 class="text-lg font-semibold mb-4 text-yellow-700 ">Formulir Pengajuan Tabungan</h2>
            <form method="POST" action="{{ route('tabungan.store') }}">
                @csrf
                <div class="grid grid-cols-1 gap-4">
                    <div>
                        <input type="text" name="full_name" placeholder="Nama Lengkap"
                            class="w-full border border-yellow-300 rounded-lg px-4 py-2 shadow-sm focus:ring-yellow-500 focus:border-yellow-500"
                            required>
                    </div>
                    <div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
            <h2 class="text-lg font-semibold mb-4 text-yellow-700">Riwayat Pengajuan</h2>
            <table class="table-auto w-full">
                <thead class="text-yellow-600">
                    <tr>
