<!-- Tambahkan Alpine.js untuk handle toggle -->
<script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script>

<nav x-data="{ open: false }" class="sticky top-0 z-50 flex flex-wrap items-center justify-between px-4 py-3 bg-white shadow md:px-8">
    <!-- Logo -->
    ...
    <!-- Login / Register OR Dashboard Desktop -->
    @if (Route::has('login'))
    ...
    <!-- Mobile Menu -->
    <div x-show="open" class="w-full mt-3 md:hidden space-y-4">
        <!-- Search Mobile -->
        <div class="flex items-center w-full bg-gray-100 rounded-md px-3 py-2">
            <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" stroke-width="2"
                viewBox="0 0 24 24">
