    ...
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8 text-gray-700">
        ...
        <div>
            ...
            <div class="flex space-x-4">
                ...
                <a href="https://x.com/bank_jateng?ref_src=twsrc%5Etfw" aria-label="Twitter" class="text-gray-500 hover:text-yellow-600 transition">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
                ...
                <a href="https://www.instagram.com/bankjatengsyariah/?hl=id" aria-label="Instagram" class="text-gray-500 hover:text-yellow-600 transition">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
